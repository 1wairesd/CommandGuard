...
import com.wairesdindustries.commandguard.spigot.titleapi.TitleAPI;
	...
	public static void executeAction(String action,Player player){
		if(action.startsWith("message: ")) {
			...
			try {
				...
				Bukkit.getConsoleSender().sendMessage(MessagesUtils.getColoredMessage(CommandGuard.getPrefix()+
